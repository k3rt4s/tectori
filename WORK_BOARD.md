...
Checkpoint, 2026-09-16 run: the path letter case fix to
`verify_site.py` is on branch `feature/hunt-stated-urls-case`, from
worktree `C:\Code\worktrees\tectori-hunt-stated-urls-case`.
